...
(function($) {
    ...
    THEMEMASCOT.slider = {
        ...
        TM_flexslider: function() {
            ...
            if ( $each_flex_slider.length > 0 ) {
                ...
                $each_flex_slider.each(function() {
                    ...
                    var data_direction = ( $flex_slider.parent().data("direcfull-event-calendartion") === undefined ) ? 'horizontal': $flex_slider.parent().data("direction");
        ...
        TM_owlCarousel: function() {
            var $owl_carousel_1col = $('.fullwidth-carousel');
            ...
            var $owl_carousel_1col = $('.owl-carousel-1col, .text-carousel, .image-carousel');
            if ( $owl_carousel_1col.length > 0 ) {
                $owl_carousel_1col.each(function() {
                    var data_dots = ( $(this).data("dots") === undefined ) ? false: $(this).data("dots");
                    var data_nav = ( $(this).data("nav") === undefined ) ? false: $(this).data("nav");
